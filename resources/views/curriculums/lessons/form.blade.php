...
<div class="form-group">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" name="code" value="{{ old('code') ?? $lesson->code }}" class="form-control {{ $errors->has('code') ? 'is-invalid' : ''}}" autocomplete="off">
...
<div class="form-group">
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" name="name" value="{{ old('name') ?? $lesson->name }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" autocomplete="off">
...
<div class="form-group">
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" name="total_hours" value="{{ old('total_hours') ?? $lesson->total_hours }}" class="form-control {{ $errors->has('total_hours') ? 'is-invalid' : ''}}" autocomplete="off">
