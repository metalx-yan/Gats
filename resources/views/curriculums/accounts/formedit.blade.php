...
<div class="form-group">
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" name="name" value="{{ $edit->name }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" autocomplete="off">
...
<div class="form-group">
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" name="username" value="{{ $edit->username  }}" class="form-control {{ $errors->has('username') ? 'is-invalid' : ''}}" autocomplete="off">
...
<a href="{{ route('user.create') }}" class="btn btn-danger form-control">Back</a>
